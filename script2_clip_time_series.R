...
#################### SET WORKING ENVIRONMENT
rootdir <- "/media/dannunzio/lecrabe/myanmar_lsat_s2_series/"
setwd(rootdir)
...
## Read the datafile 
pts <- read.table("/media/dannunzio/OSDisk/Users/dannunzio/Documents/countries/myanmar/70_test_plots.txt",header = T)
